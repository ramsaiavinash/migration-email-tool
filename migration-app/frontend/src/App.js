      ...
      <aside style={s.sidebar}>
        <div style={s.sidebarTop}>
          <div style={s.logo}>
            ...
            <div>
              <div style={s.logoName}>MigraPulse</div>
              <div style={s.logoSub}>CHSPSC LLC</div>
            </div>
          </div>
          <nav style={s.nav}>
            {navItems.map(item => (
        ...
        <div style={s.sidebarBottom}>
          <div style={s.sidebarUser}>
            ...
            <div>
              <div style={{ fontSize:13,fontWeight:600,color:"#f1f5f9" }}>IT Admin</div>
              <div style={{ fontSize:11,color:"#94a3b8" }}>Migration Team</div>
            </div>
          </div>
        </div>
      </aside>
          ...
          <div className="fade-in">
            <header style={s.topbar}>
              ...
              <div style={{ display:"flex",gap:10,alignItems:"center" }}>
                <div style={s.statusBadge}><span style={s.statusDot}></span>Power Automate connected</div>
                ...
                <div key={i} style={{ ...s.kpiCard, background:kpi.bg, border:`1px solid ${kpi.border}` }}>
                  <div style={{ display:"flex",justifyContent:"space-between",alignItems:"flex-start" }}>
                    <div>
                      ...
                      <div style={{ fontSize:12,color:"#64748b",marginTop:6,fontWeight:500 }}>{kpi.label}</div>
                    </div>
              ...
              {!results && (
                <div style={s.card}>
                  ...
                  <div style={{ ...s.dropzone,...(dragOver?s.dropzoneHover:{}),...(file?s.dropzoneFilled:{}) }}
                    ...
                    {file?(
                      <div style={s.fileRow}>
                        <div style={s.fileIconBox}><svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><path d="M13 2H6a2 2 0 00-2 2v16a2 2 0 002 2h12a2 2 0 002-2V9z"/><polyline points="13 2 13 9 20 9"/></svg></div>
                        <div style={{ flex:1 }}>
                          <div style={{ fontSize:14,fontWeight:600,color:"#0f172a" }}>{file.name}</div>
                          <div style={{ fontSize:12,color:"#64748b",marginTop:2 }}>{(file.size/1024).toFixed(1)} KB · Ready to process</div>
                        </div>
                      ...
                      <div style={{ textAlign:"center" }}>
                        <div style={s.uploadIconWrap}><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="#0ea5e9" strokeWidth="1.5" strokeLinecap="round" strokeLinejoin="round"><path d="M21 15v4a2 2 0 01-2 2H5a2 2 0 01-2-2v-4M17 8l-5-5-5 5M12 3v12"/></svg></div>
              ...
              {results&&(
                <div style={s.card} className="fade-in">
                  <div style={s.resultHeader}>
                    <div style={s.resultCheck}><svg width="28" height="28" viewBox="0 0 24 24" fill="none" stroke="white" strokeWidth="2.5" strokeLinecap="round" strokeLinejoin="round"><polyline points="20 6 9 17 4 12"/></svg></div>
                    <div>
            ...
            <div style={{ display:"flex",flexDirection:"column",gap:20 }}>
              <div style={s.card}>
                <div style={s.cardHeader}>
                  ...
                  <div><h2 style={s.cardTitle}>Power Automate configuration</h2><p style={s.cardSub}>Backend .env file settings</p></div>
                </div>
                <div style={{ padding:"16px 24px 20px" }}>
                  {[
                    ...
                    <div key={item.key} style={{ marginBottom:16 }}>
                      <div style={{ fontSize:12,fontWeight:600,color:"#374151",marginBottom:4 }}>{item.label}</div>
                      <div style={{ fontSize:12,fontFamily:"monospace",background:"#f8fafc",border:"1px solid #e2e8f0",borderRadius:8,padding:"8px 12px",color:"#0f172a" }}>{item.value}</div>
              ...
              <div style={s.card}>
                <div style={s.cardHeader}>
                  ...
                  <div><h2 style={s.cardTitle}>System status</h2><p style={s.cardSub}>Current connection health</p></div>
                </div>
                <div style={{ padding:"16px 24px 20px" }}>
                  {[
      ...
      <div style={{ display:"flex",gap:4,alignItems:"flex-end",height:140,marginBottom:8 }}>
        {runs.slice(0,8).reverse().map((run,i)=>(
          <div key={run.id} style={{ flex:1,display:"flex",flexDirection:"column",alignItems:"center",gap:2 }}>
            ...
            <div style={{ fontSize:9,color:"#94a3b8",textAlign:"center",overflow:"hidden",textOverflow:"ellipsis",whiteSpace:"nowrap",width:"100%" }}>#{runs.length-i}</div>
          </div>
        ))}
      </div>
      <div style={{ display:"flex",gap:16,justifyContent:"center" }}>
        <div style={{ display:"flex",alignItems:"center",gap:4,fontSize:11,color:"#64748b" }}><div style={{ width:10,height:10,borderRadius:2,background:"#22c55e" }}/> Sent</div>
        <div style={{ display:"flex",alignItems:"center",gap:4,fontSize:11,color:"#64748b" }}><div style={{ width:10,height:10,borderRadius:2,background:"#ef4444" }}/> Failed</div>
      </div>
    </div>
  );
}
